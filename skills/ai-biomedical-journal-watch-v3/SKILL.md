---
name: ai-biomedical-journal-watch-v3
...
5. Assign `include`, `context`, `exclude`, or `needs_evidence` per record. Never implement decisions as DOI/title sets, dictionaries, tuples, whitelists, blacklists, or summary override tables in executable code.
